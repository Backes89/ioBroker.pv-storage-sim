...
/**
 * Normiert einen Strompreis auf €/kWh. Dynamische Tarif-Adapter (z. B. Tibber) liefern
 * €/kWh, andere Quellen ct/kWh. Negative Werte (negative Spotpreise) bleiben erhalten.
 *
 * @param {number} value
 * @param {string} [unit]  'eur_kwh' (Standard) oder 'ct_kwh'
 * @returns {number} Preis in €/kWh
 */
function toEurPerKwh(value, unit) {
    return unit === 'ct_kwh' ? value / 100 : value;
}

module.exports = { stepBattery, splitSignedPower, unitFactor, toEurPerKwh };
