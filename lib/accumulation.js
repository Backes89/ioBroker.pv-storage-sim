 ...
 *
 * @typedef {{chargedToday:number, dischargedToday:number, importOrigToday:number,
 *            importSimToday:number, exportOrigToday:number, exportSimToday:number,
 *            savingsToday:number, savingsMonth:number, savingsYear:number}} DayAccumulators
 * @typedef {{chargedTotal:number, dischargedTotal:number, savingsTotal:number}} Totals
 *
 * @param {{acc: DayAccumulators, totals: Totals}} state  Akkumulatoren + Gesamtwerte
 * @param {object} tick
 ...
 * @returns {{acc: DayAccumulators, totals: Totals, coverage:number, amortizationYears:number}}
 */
