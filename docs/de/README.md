# ioBroker.pv-storage-sim — Deutsche Dokumentation

> Die englische Hauptdokumentation liegt im [README.md](../../README.md) im Wurzelverzeichnis.
> Neue Changelog-Einträge werden dort (englisch) und in `io-package.json` (en/de) gepflegt;
> das vollständige deutsche Changelog-Archiv bis 0.0.37 steht unten in diesem Dokument.
